...
We were having trouble getting the red dot appearing on the emulator even though it displayed on an Android phone
...
// This whole section is a Bitmap.java version that works on an emulator but  not on a phone. 
// The above works on a phone but not an emulator. See README.txt
// This works on Device: Nexus One (3.7", 480 x 800: hdpi), Target: Android 4.2.2 - API Level 17
/*
package com.example.bumap;
